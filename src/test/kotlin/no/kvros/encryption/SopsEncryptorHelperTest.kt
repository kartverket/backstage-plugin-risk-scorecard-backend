    ...
    fun `test at sops fungerer med egen versjon`() {
        val sopsHelper = SopsEncryptorHelper(
            listOf(
                SopsProviderAndCredentials(
                    ...
                    publicKeyOrPath = "projects/spire-ros-5lmr/locations/eur4/keyRings/ROS/cryptoKeys/ros-as-code"
                )
            )
        )
        ...
        assertDoesNotThrow {
            SopsEncryptorForYaml.decrypt(
                ciphertext = "skjemaVersjon: ENC[AES256_GCM,data:QkZw9vG+w0wy,iv:k5AuVA4WuMhq8h7ipr4oJFyX7N83tU88EBVPipD2cvc=,tag:Xw8BCVH/Qh22GeRCdGlgMA==,type:str]\n" +
