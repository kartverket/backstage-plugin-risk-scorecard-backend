...
class MigrationFunctionTests {
    ...
    fun `test migrateFrom54To55 remaps preset risk values and keeps arbitrary values`() {
        ...
        assertEquals(RiScScenarioRisk(probability = 0.02, consequence = 10_000.0), migratedRiSc.scenarios[0].risk)
        ...
        assertEquals(RiScScenarioRisk(probability = 50.0, consequence = 250_000_000.0), migratedRiSc.scenarios[2].risk)
                ...
                scenarios =
                    listOf(
                        ...
                        MigrationChange55Scenario(
                            ...
                            id = "CCCCC",
                            changedRiskProbability = MigrationChangedValue(400.0, 50.0),
