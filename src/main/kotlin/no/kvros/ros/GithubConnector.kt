...
class GithubConnector : WebClientConnector("https://api.github.com/repos") {
    ...
    private fun fetchROSContentFromGithub(
        ...
        id: String,
        accessToken: String,
    ): ROSContentDTO? = getGithubResponse("/$owner/$repository/contents/$pathToROS/$id.ros.yaml", accessToken).rosContent()
    ...
    private fun fetchROSIdsFromGithub(
        ...
        pathToRoser: String,
        accessToken: String,
    ): List<ROSFilenameDTO>? = getGithubResponse("/$owner/$repository/contents/$pathToRoser", accessToken).rosFilenames()
    ...
    private fun ResponseSpec.rosFilenames(): List<ROSFilenameDTO>? = this.bodyToMono<List<ROSFilenameDTO>>().block()
