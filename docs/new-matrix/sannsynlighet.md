...
Bruk av sannsynlighetsskalaen:
Vurdering av sannsynlighet skjer for den hendelsen eller det scenariet som risikovurderes.

1 – Svært liten sannsynlighet
...
Det er usannsynlig at trusselaktøren initierer trusselhendelsen.
Krever flere aktive feil eller uvanlige forutsetninger samtidig, og/eller bistand fra innsider.
Måloppnåelse:
Målet/oppdaget er kjent og gjenomføres i ordinær drift. Det er få innsatsfaktorer, ingen ekstern påvirkning, lave kostnader, oversiktlig kostnadsbilde og tilstrekkelig ramme.

2 – Liten sannsynlighet
Hendelsen kan inntreffe, men skjer sjeldent. Det er eksempler på at det har skjedd, enten i egen virksomhet eller andre sammenlignbare virksomheter eller systemer tilbake i tid. Tidsperspektivet for mulige hendelser er innenfor 10-30 år.
Tilsiktede hendelser:
Det er lite sannsynlig at trusselaktøren initierer trusselhendelsen.
...
Tilsiktede hendelser:
Trusselaktør vil med stor sannsynlighet initiere trusselhendelsen.
Sårbarheter er kjent for profesjonelle aktører. Det er etablert kontroller, men disse er ikke fullstendig implementert.
Måloppnåelse:
...
Tilsiktede hendelser:
Det er nesten garantert at en trusselaktør vil initiere trusselhendelsen.
Sårbarheter er kjent bredt, kontroller mangler, er utdaterte eller omgås rutinemessig.
Måloppnåelse:
